...
p['data_path']['parameterspace_label'] = 'self_prediction'

# parameters for setting up the network  
p['M'] = 5                   # number of subpopulations
p['n_E'] = 200               # number of excitatory neurons per subpopulation
...
p['soma_model'] = 'iaf_psc_exp_nonlineardendrite_v3'
p['soma_params'] = {}
...
p['syn_dict_ee']['zt'] = 1. + 4.07 #1.+3.07                     # target dAP trace
p['syn_dict_ee']['lambda_h'] = 0.11                  # homeostasis rate
...
p['syn_dict_ee']['lambda_minus'] = 0.0013*7.5 #0.0013*2.5             # depression rate
...
p['seed'] = 1 #para.ParameterRange([1,2,3,4,5])   # seed for NEST
...
p['sparse_first_char'] = True#False                 # if turned on, the dAP of a subset of neurons in the subpopulation representing 
...
p['task']['vocab_size'] = 5                   # vocabulary size
...
p['learning_episodes'] = 100#85                     # total number of training episodes ('repetitions of the sequence sets')
