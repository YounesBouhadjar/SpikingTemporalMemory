...
p['data_path']['parameterspace_label'] = 'prediction_performance_task3'
...
p['syn_dict_ee']['lambda_plus'] = 0.39               # potentiation rate
p['syn_dict_ee']['zt'] = 1.                          # target dAP trace
p['syn_dict_ee']['lambda_h'] = 0.034                 # homeostasis rate
...
p['syn_dict_ee']['lambda_minus'] = 0.005785 #or 0.0058 # depression rate: in (Bouhadjar et al. 2022, PloS CB), we indicate that we use 0.0057. Use rather 0.005785 or 0.0058. 
...
p['task']['task_type'] = 3                     # this chooses between three hard coded sequence sets (see ./utils.py)
