...
try:
    ...
    print("missing simulation script or parameters space!")
    raise
...
file.write('#SBATCH --mem=2000\n')                                          # and reserve 2GB of memory
file.write('source activate spiking-htm\n')                                 # activate conda environment
file.write('srun python %s %s \n' % (simulation_script, pars_space) )       # call simulation script
file.close()
